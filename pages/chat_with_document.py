...
with st.expander("### Övning"):  # Gör rubriken lika stor som underrubriken
    ...
    user_text = st.text_area("Här nedanför kan du ladda upp dokument från din dator och sedan chatta med innehållet. Du kan ställa frågor om innehållet, som om du hade en konversation med någon som känner till dokumentets innehåll. OpenAI
