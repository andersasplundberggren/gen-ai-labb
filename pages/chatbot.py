...
with st.expander("### Övning"):  # Gör rubriken lika stor som underrubriken
    ...
    st.write("Tips. Skriv din prompt gör sedan radbryt med hjälp av shift + enter och skriv in tre --- och efter det ytterligare ett radbryt med shift + enter. Klistra sedan in texten som du kopierat. Du kan även testa att kopiera länken till sidan på Wikipedia och klistra in i din prompt.")
