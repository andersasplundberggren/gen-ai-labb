...
# Ladda och ändra storlek på logotypen
logo_path = "images/logome.png"
logo = Image.open(logo_path)
logo = logo.resize((100, 100))  # Ändra storleken till 100x100 pixlar (justera efter behov)

# Visa logotypen med den nya storleken
st.image(logo, caption="Logotyp", use_column_width=False)
