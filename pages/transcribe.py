...
with st.expander("### Övning"):  
    st.markdown("""
        ...
        ### Transkribering:
        Här nedanför kan du ladda upp eller spela in ljudfiler som sedan kommer transkriberas till text. 
        
        
        - Testa spela in och prata på, när du klickar stopp avslutas inspelningen och du får ut det du sgt som text.
        - Visste du att du kan använda transkribering i Word? Om inte testa genom att öppna ett worddokument och välj **Diktera** under menyn **Start**.
